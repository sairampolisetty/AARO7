...
export default function Header() {
    ...
    return (
        <>
            {/* Overlay to catch clicks outside the mobile menu */}
            <div
                className={`fixed inset-0 z-[998] transition-opacity duration-300 md:hidden ${isMobileMenuOpen ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'}`}
