...
export default function Marquee() {
    return (
        <div className="w-full overflow-hidden bg-background py-8 border-y border-foreground/10 flex whitespace-nowrap relative">
            <style>{`
            ...
            <div className="flex whitespace-nowrap animate-raw-marquee">
                {Array.from({ length: 4 }).map((_, i) => (
                    <span
                        ...
                        style={{
                            WebkitTextStroke: "1px rgba(47, 47, 47, 0.6)",
                        }}
                    >
